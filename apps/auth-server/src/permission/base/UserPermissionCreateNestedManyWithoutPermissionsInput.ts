...
@InputType()
class UserPermissionCreateNestedManyWithoutPermissionsInput {
...
export { UserPermissionCreateNestedManyWithoutPermissionsInput as UserPermissionCreateNestedManyWithoutPermissionsInput };
