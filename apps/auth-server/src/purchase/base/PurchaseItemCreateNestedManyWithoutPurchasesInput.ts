...
@InputType()
class PurchaseItemCreateNestedManyWithoutPurchasesInput {
...
export { PurchaseItemCreateNestedManyWithoutPurchasesInput as PurchaseItemCreateNestedManyWithoutPurchasesInput };
