...
@InputType()
class ResellerPackageUpdateManyWithoutResellersInput {
...
export { ResellerPackageUpdateManyWithoutResellersInput as ResellerPackageUpdateManyWithoutResellersInput };
