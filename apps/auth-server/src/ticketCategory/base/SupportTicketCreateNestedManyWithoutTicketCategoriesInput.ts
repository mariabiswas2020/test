...
@InputType()
class SupportTicketCreateNestedManyWithoutTicketCategoriesInput {
...
export { SupportTicketCreateNestedManyWithoutTicketCategoriesInput as SupportTicketCreateNestedManyWithoutTicketCategoriesInput };
