...
@InputType()
class SupportTicketUpdateManyWithoutTicketCategoriesInput {
...
export { SupportTicketUpdateManyWithoutTicketCategoriesInput as SupportTicketUpdateManyWithoutTicketCategoriesInput };
