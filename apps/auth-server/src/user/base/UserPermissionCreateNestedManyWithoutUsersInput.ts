...
@InputType()
class UserPermissionCreateNestedManyWithoutUsersInput {
...
export { UserPermissionCreateNestedManyWithoutUsersInput as UserPermissionCreateNestedManyWithoutUsersInput };
